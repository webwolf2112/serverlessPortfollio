...
var _exampleWork = __webpack_require__(27);
...
_reactDom2['default'].render(_react2['default'].createElement(_exampleWork2['default'], { work: myWork }), document.getElementById('exampleWork'));
...
var _exampleWorkModal = __webpack_require__(28);
...
var ExampleWork = function (_React$Component) {
	...
	_createClass(ExampleWork, [{
		key: 'openModal',
		value: function () {
			function openModal(evt, example) {
				this.setState({
					'modalOpen': true,
		...
		key: 'closeModal',
		value: function () {
			function closeModal(evt, example) {
				this.setState({
					'modalOpen': false
				});
			}
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						this.props.work.map(function (example, idx) {
							return _react2['default'].createElement(ExampleWorkBubble, { example: example, key: idx, openModal: _this2.openModal });
						})
					),
					_react2['default'].createElement(_exampleWorkModal2['default'], { example: this.state.selectedExample, open: this.state.modalOpen, closeModal: this.closeModal })
				);
			}
			...
			function render() {
				...
				return _react2['default'].createElement(
					...
					{ className: 'section__exampleWrapper',
						onClick: function () {
							function onClick(e) {
								return _this4.props.openModal(e, example);
							}
    ...
    value: function () {
      function render() {
        ...
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            'span',
            { className: 'color--cloud modal__closeButton', onClick: this.props.closeModal },
